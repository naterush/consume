# Math
I'd like to learn the basics (the introduction to) a variety of fields. Generally organized in the order they should be learned (where sections separated by ----- can be learned in parallel [WIP]).
...
- [Set Theory: A First Course](https://www.amazon.com/Set-Theory-Cambridge-Mathematical-Textbooks/dp/1107120322/ref=sr_1_6?s=books&ie=UTF8&qid=1515690687&sr=1-6&keywords=set+theory)


## Type Theory
- [Introduction to Type Theory](http://www.cs.ru.nl/~herman/onderwijs/provingwithCA/paper-lncs.pdf)
- [Type Theory and Formal Proof: An Introduction](https://www.amazon.com/Type-Theory-Formal-Proof-Introduction/dp/110703650X/ref=sr_1_1?s=books&ie=UTF8&qid=1515691057&sr=1-1&keywords=type+theory)

## Category Theory
- [Introduction to Category Theory](https://arxiv.org/pdf/1612.09375.pdf)
- [Introduction to Category Theory (with exercises)](http://www.cs.man.ac.uk/~hsimmons/zCATS.pdf)
- [Category Theory (Oxford Logic Guides)](https://www.amazon.com/Category-Theory-Oxford-Logic-Guides/dp/0199237182/ref=sr_1_2?s=books&ie=UTF8&qid=1515690784&sr=1-2&keywords=category+theory)

## Topology
- [Topology](https://www.amazon.com/Topology-Classic-Classics-Advanced-Mathematics/dp/0134689518/ref=sr_1_2?ie=UTF8&qid=1515703843&sr=8-2&keywords=munkres+topology)
